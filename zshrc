...
export PYTHONPATH="/home/njric/code/njric/data-context-and-setup-olist:$PYTHONPATH"
...
FZF_CTRL_R_OPTS="--height 50% --preview 'echo {2..} | bat --color=always -pl sh' --preview-window 'wrap,up,5'"
